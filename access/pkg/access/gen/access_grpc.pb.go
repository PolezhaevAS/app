...
func (c *accessClient) UserAccess(ctx context.Context, in *UserAccessRequest, opts ...grpc.CallOption) (*UserAccessResponse, error) {
	out := new(UserAccessResponse)
	err := c.cc.Invoke(ctx, "/access.Access/UserAccess", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAccessServer) UserAccess(context.Context, *UserAccessRequest) (*UserAccessResponse, error) {
...
func _Access_UserAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserAccessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccessServer).UserAccess(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/access.Access/UserAccess",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccessServer).UserAccess(ctx, req.(*UserAccessRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Access_UserAccess_Handler,
		},
	},
